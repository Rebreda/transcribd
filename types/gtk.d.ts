...
export type WidgetActionActivateFunc = (widget: Widget, action_name: string, parameter: GLib.Variant) => void;
...
export class GestureClick extends GestureSingle {
    ...
    emit(signal: "unpaired-release", x: number, y: number, button: number, sequence: Gdk.EventSequence): void;
